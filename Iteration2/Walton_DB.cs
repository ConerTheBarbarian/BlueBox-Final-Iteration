        ...
        while (Retry >= 0)
        {
            try
            {
                if (lo_Connection == null)
                {
                    ...
                    lo_Connection.ConnectionString = "Data Source=ESSQL1.walton.uark.edu;Initial Catalog=ISYS4283Team05;user id=ISYS4283Team05;password=WK20ogc$;Persist Security Info=False;";
                }
